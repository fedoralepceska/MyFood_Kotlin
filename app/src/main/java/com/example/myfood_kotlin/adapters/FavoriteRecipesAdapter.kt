...
import com.example.myfood_kotlin.databinding.FavoriteRecipesRowLayoutBinding
import com.example.myfood_kotlin.ui.fragments.favorites.FavoriteRecipesFragmentDirections
...
class FavoriteRecipesAdapter(
    ...
    override fun onDestroyActionMode(mode: ActionMode?) {
        myViewHolder.forEach{
            holder -> changeRecipeStyle(holder, R.color.cardBackgroundColor, R.color.strokeColor)
        }
        multiSelection = false
        selectedRecipes.clear()
